...
setCarregando(false);
          ...
          <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
            <div className="min-w-0">
              ...
              <p className="mt-3 max-w-3xl text-sm leading-6 text-[#5F564C]">
                Aqui ficam as situações que você registrou para observar
                repetição de expectativa, pensamento, reação e consequência.
              </p>
            </div>
  ...
  <div className="mb-5">
    ...
    <h2 className="text-xl font-semibold text-[#2F2A24]">
      Onde seu padrão tem se repetido
    </h2>

    <p className="mt-3 text-sm leading-6 text-[#5F564C]">
      Esta leitura usa apenas os registros que você já salvou. Quanto mais
      situações reais forem registradas, mais clara a repetição começa a ficar.
    </p>
  </div>
        ...
        {situacoes.length === 0 ? (
          <section className="rounded-3xl border border-[#E5DDD2] bg-white p-6 text-center shadow-sm sm:p-8">
            ...
            <h2 className="mt-3 text-2xl font-semibold text-[#2F2A24]">
              O padrão ainda não foi observado na vida real
            </h2>

            <p className="mx-auto mt-4 max-w-2xl text-sm leading-6 text-[#5F564C]">
              O teste aponta uma leitura inicial. Os registros mostram onde o
              funcionamento aparece no cotidiano. Sem vida real, o padrão fica
              bonito no relatório e inútil na prática. Coisa bem humana, aliás.
            </p>
